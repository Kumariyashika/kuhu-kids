...
@section('content')
    <div class="inner-container">
        ...
        <div class="category-menu-bar"
            style="display: flex; gap: 8px; justify-content: center; align-items: center; width: 100%; margin-bottom: 12px; flex-wrap: wrap; z-index: 10;">
        ...
        <div class="pop-score-board"
            style="border-radius: 16px 16px 0 0; border: 3px solid var(--color-green-real); border-bottom: none; background: #F7FAFC; padding: 10px 20px; display: flex; flex-direction: column; gap: 10px;">
            ...
            <!-- Target Prompt Row -->
            <div
                style="display: flex; justify-content: center; align-items: center; gap: 16px; padding: 4px 0; width: 100%;">
                <div style="text-align: center; display: flex; align-items: center; gap: 10px;">
                    <span id="instructionLabel" style="font-size: 1.4rem; font-weight: 800; color: #4A5568;">Find
                        balloon:</span>
                    <div id="targetBadge"
                        style="display: inline-flex; align-items: center; justify-content: center; min-width: 65px; height: 65px; border-radius: 16px; background: white; border: 4px solid var(--color-yellow); box-shadow: 0 4px 10px rgba(0,0,0,0.06); font-size: 2.5rem; font-weight: 900; color: var(--color-purple); padding: 4px; transition: all 0.2s ease;">
                        A
                    </div>
                </div>

                <button onclick="speakInstruction()" class="btn-3d btn-yellow"
                    style="width: 44px; height: 44px; border-radius: 50%; padding: 0; display: flex; align-items: center; justify-content: center; font-size: 1.4rem; margin: 0;"
                    title="Hear Voice Audio">
                    🔊
                </button>
            </div>
        </div>
        ...
        <div class="balloon-pop-game-area" id="gameArea">
            <div id="startScreen"
                style="position: absolute; width: 100%; height: 100%; background: rgba(255,255,255,0.92); display: flex; flex-direction: column; justify-content: center; align-items: center; z-index: 50; gap: 20px;">
                <h2
                    style="font-size: 2.2rem; font-weight: 800; color: var(--color-purple); text-align: center; margin: 0 15px;">
                    Ready to learn with balloons?</h2>
                <p style="font-size: 1.1rem; color: #718096; margin: 0 20px; text-align: center;">Touch the correct balloon
                    to clear the level and earn stars! 🌟</p>
                <button onclick="startGame()" class="btn-3d"
                    style="font-size: 1.6rem; padding: 16px 48px; background: var(--color-green-real); color: white; border-bottom: 6px solid var(--color-green-real-shadow);">
                    ▶️ Start Game!
                </button>
            </div>
