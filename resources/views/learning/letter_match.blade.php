...
@section('content')
    <div class="inner-container" style="position: relative;">
        ...
        <div
            style="background: #FFFDF0; padding: 15px; border-radius: 20px; border: 3px solid #E2E8F0; text-align: center; margin-bottom: 24px;">
            <h2 style="color: var(--color-blue); font-size: 1.4rem; font-weight: 800; margin: 0;">Draw a line to match the
                letters! ✏️</h2>
        </div>

        <!-- Match Game Grid with SVG overlay -->
        <div class="matching-game-area" id="matchingArea"
            style="position: relative; display: flex; justify-content: space-between; gap: 80px; padding: 20px; background: white; border-radius: 24px; border: 3px solid #E2E8F0; min-height: 400px; user-select: none;">
            ...
            <div class="match-column" id="uppercaseColumn"
                style="display: flex; flex-direction: column; gap: 24px; z-index: 10; width: 40%;">
                <!-- Populated dynamically -->
            </div>

            <!-- Right Column (Uppercase - Shuffled) -->
            <div class="match-column" id="lowercaseColumn"
                style="display: flex; flex-direction: column; gap: 24px; z-index: 10; width: 40%;">
                <!-- Populated dynamically -->
            </div>
        </div>
        ...
        <div id="miniGameOverlay"
            style="display: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(180deg, #A1E3FF 0%, #D4F3FF 100%); border-radius: 30px; z-index: 100; flex-direction: column; align-items: center; justify-content: center; padding: 24px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <h2 id="miniGameTitle"
                style="color: #FF5252; font-size: 2.2rem; font-weight: 900; margin: 0 0 5px 0; text-shadow: 2px 2px 0px rgba(0,0,0,0.05); font-family: 'Fredoka', sans-serif;">
                🎈 Balloon Pop Bonus!</h2>
            <p id="miniGameSub"
                style="font-size: 1.3rem; font-weight: 800; color: #4A3B00; margin: 0 0 20px 0; font-family: 'Fredoka', sans-serif;">
                Pop 5 balloons to unlock the next level!</p>

            <div id="miniGameArea"
                style="width: 100%; flex: 1; position: relative; background: rgba(255, 255, 255, 0.4); border-radius: 24px; border: 3px dashed #FFF; overflow: hidden; cursor: crosshair;">
                <!-- Balloons or bubbles will spawn dynamically here -->
            </div>

            <button id="miniGameNextBtn" class="btn-3d"
                style="display: none; background: var(--color-green-real); border-bottom: 6px solid var(--color-green-real-shadow); color: white; font-size: 1.4rem; padding: 12px 36px; border-radius: 20px; margin-top: 20px; cursor: pointer; font-family: 'Fredoka', sans-serif;">
                Play Level 2 ➡️
            </button>
        </div>
    </div>
