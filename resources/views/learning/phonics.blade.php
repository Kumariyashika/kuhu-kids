...
<div class="inner-container">
    ...
    <div style="background: #FFFDF0; padding: 20px; border-radius: 20px; border: 3px solid #E2E8F0; text-align: center; margin-bottom: 24px; display: flex; flex-direction: column; align-items: center; gap: 12px;">
        <h2 id="instructionHeader" style="color: var(--color-orange); font-size: 1.5rem; font-weight: 800; margin: 0;">Press any letter card to hear how it sounds! 🔊</h2>
        <button onclick="toggleAutoplay()" id="autoplayBtn" class="btn-3d" style="background-color: var(--color-green-real); color: white; border-bottom: 5px solid var(--color-green-real-shadow); font-size: 1.1rem; padding: 8px 24px; transition: all 0.15s ease;">
            ▶️ Autoplay
        </button>
    </div>

    <!-- Category Tabs for Phonics -->
    <div class="category-tabs" style="display: flex; gap: 12px; margin-bottom: 24px; justify-content: center; flex-wrap: wrap;">
        <button onclick="changeCategory('english_letters')" id="tab-english_letters" class="btn-3d btn-pink category-tab-btn" style="min-width: 140px; padding: 10px 16px; font-size: 0.95rem;">
            🔤 Letters (A-Z)
        </button>
        <button onclick="changeCategory('hindi_letters')" id="tab-hindi_letters" class="btn-3d btn-yellow category-tab-btn" style="min-width: 140px; padding: 10px 16px; font-size: 0.95rem;">
            🕉️ Hindi (क-ज्ञ)
        </button>
        <button onclick="changeCategory('numbers')" id="tab-numbers" class="btn-3d btn-yellow category-tab-btn" style="min-width: 140px; padding: 10px 16px; font-size: 0.95rem;">
            🔢 Numbers (1-50)
        </button>
        <button onclick="changeCategory('english_words')" id="tab-english_words" class="btn-3d btn-yellow category-tab-btn" style="min-width: 140px; padding: 10px 16px; font-size: 0.95rem;">
            🍎 Words (A-Z)
        </button>
        <button onclick="changeCategory('number_words')" id="tab-number_words" class="btn-3d btn-yellow category-tab-btn" style="min-width: 140px; padding: 10px 16px; font-size: 0.95rem;">
            🔢 Number Words (1-20)
        </button>
        <button onclick="changeCategory('hindi_words')" id="tab-hindi_words" class="btn-3d btn-yellow category-tab-btn" style="min-width: 140px; padding: 10px 16px; font-size: 0.95rem;">
            🕊️ Hindi Words (क-ज्ञ)
        </button>
    </div>
