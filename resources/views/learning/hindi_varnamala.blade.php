...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Fredoka:wght@400;600;700&family=Rozha+One&family=Tiro+Devanagari+Hindi&family=Nunito:wght@700;800;900&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        * {
        ...
        .app-bar {
            width: 100%;
            max-width: 520px; /* 1080x1920 mobile portrait aspect ratio */
            display: flex;
