...
@section('content')
    ...
    <header class="top-header">
        ...
        <div class="profile-pill">
            <div class="profile-avatar" style="position: relative; overflow: visible;">
                ...
                @if($activeChild->current_outfit === 'crown')
                    <div class="avatar-accessory accessory-crown" style="position: absolute; top: -14px; left: 50%; transform: translateX(-50%); width: 34px; height: 25px; z-index: 10; pointer-events: none;">
                ...
                @elseif($activeChild->current_outfit === 'glasses')
                    <div class="avatar-accessory accessory-glasses" style="position: absolute; top: 12px; left: 50%; transform: translateX(-50%); width: 40px; height: 18px; z-index: 10; pointer-events: none;">
                ...
                @elseif($activeChild->current_outfit === 'superhero')
                    <div class="avatar-accessory accessory-superhero" style="position: absolute; bottom: 0px; left: 50%; transform: translateX(-50%); width: 44px; height: 16px; z-index: 10; pointer-events: none;">
        ...
        <div class="header-actions">
            <div class="stars-pill">
                <!-- Star SVG Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="#FFDE59" stroke="#E6A100" stroke-width="2">
    ...
    <main class="modules-grid">
        ...
        <a href="{{ route('learning.tracing') }}" class="module-card module-card-purple">
            <div class="card-icon-container">
                ...
                <svg viewBox="0 0 100 100" width="90" height="90">
                    <text x="35" y="80" font-family="'Fredoka', sans-serif" font-size="80" font-weight="900" fill="none" stroke="#FFFFFF" stroke-width="4" stroke-dasharray="4,4">A</text>
                    <!-- Hand Icon Tracing -->
                    <g transform="translate(42, 45) scale(0.6)">
                        <path d="M30 45 C30 40 25 35 20 35 C15 35 15 45 15 45 C15 45 12 30 5 30 C-2 30 -2 45 -2 45 C-2 45 -5 28 -12 28 C-19 28 -19 45 -19 45 L-19 55 C-19 65 -10 75 0 75 L15 75 C25 75 30 65 30 55 Z" fill="#FFE0B2" stroke="#E65100" stroke-width="3"/>
                        <rect x="-35" y="40" width="18" height="35" rx="3" fill="#FFE0B2" stroke="#E65100" stroke-width="3" transform="rotate(-30)"/>
                    </g>
                    <!-- Sparkle Stars -->
            ...
            <h2 class="card-title">Alphabet Tracing</h2>
            <span class="card-subtitle">Learn A-Z Letters</span>
        </a>
            ...
            <div class="card-icon-container">
                ...
                <svg viewBox="0 0 100 100" width="90" height="90">
                    <g transform="translate(10, 10)">
                        ...
                        <!-- Music Notes -->
                        <path d="M60 25 C60 15, 75 10, 75 10 L75 25 M60 25 C55 25, 50 30, 50 35 C50 40, 55 45, 60 45 C65 45, 65 35, 65 25 M75 20 C70 20, 68 25, 68 30 C68 35, 73 40, 78 40 C83 40, 83 30, 83 20" fill="none" stroke="#FF5252" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    </g>
                </svg>
            </div>
            <h2 class="card-title">Phonics Sounds</h2>
            <span class="card-subtitle">Learn Letter Sounds</span>
        </a>
        ...
        <a href="{{ route('learning.balloon_pop') }}" class="module-card module-card-green">
            ...
            <h2 class="card-title">Balloon Pop</h2>
            <span class="card-subtitle">Pop & Learn Letters</span>
        </a>
            ...
            <div class="card-icon-container">
                ...
                <svg viewBox="0 0 100 100" width="90" height="90">
                    ...
                    <g transform="translate(15, 20)">
                        <path d="M0 0 L25 0 Q30 -8 38 0 L50 0 L50 15 Q58 20 50 28 L50 40 L0 40 Z" fill="#FFCA28" stroke="#F57F17" stroke-width="2"/>
                        <text x="15" y="28" font-size="24" font-weight="bold" fill="#F57F17">A</text>
                    </g>
                    <!-- Right Piece (Pink B) -->
                    <g transform="translate(45, 28)">
                        <path d="M0 0 L25 0 L25 35 L0 35 L0 25 Q-8 20 0 15 Z" fill="#EC407A" stroke="#C2185B" stroke-width="2"/>
                        <text x="8" y="25" font-size="22" font-weight="bold" fill="white">B</text>
                    </g>
                </svg>
            </div>
            <h2 class="card-title">Letter Match</h2>
            <span class="card-subtitle">Match Letters Easily</span>
        </a>
            ...
            <div class="card-icon-container">
                ...
                <svg viewBox="0 0 100 100" width="90" height="90">
                    <g transform="translate(20, 10)">
                        <!-- Gold Cup -->
                        <path d="M10 10 L50 10 L45 45 C40 55, 20 55, 15 45 Z" fill="#FFDE59" stroke="#E6A100" stroke-width="3"/>
                        <rect x="25" y="52" width="10" height="15" fill="#E6A100"/>
                        <ellipse cx="30" cy="68" rx="20" ry="6" fill="#FFDE59" stroke="#E6A100" stroke-width="3"/>
                        <!-- Handles -->
                        <path d="M10 20 C0 20, 0 35, 12 35" fill="none" stroke="#FFDE59" stroke-width="4" stroke-linecap="round"/>
                        <path d="M50 20 C60 20, 60 35, 48 35" fill="none" stroke="#FFDE59" stroke-width="4" stroke-linecap="round"/>
                        <!-- Star on Trophy -->
                        <polygon points="30,22 33,28 39,28 34,31 36,36 30,33 24,36 26,31 21,28 27,28" fill="#FF914D"/>
                    </g>
                </svg>
            </div>
            <h2 class="card-title">English Rhymes</h2>
            <span class="card-subtitle">Sing, Learn & Enjoy</span>
        </a>
        ...
        <a href="{{ route('learning.hindi_rhymes') }}" class="module-card module-card-teal">
            <div class="card-icon-container">
                ...
                <svg viewBox="0 0 100 100" width="90" height="90">
                    <text x="10" y="45" font-family="'Fredoka', sans-serif" font-size="34" font-weight="bold" fill="#FFE5A3" stroke="#D18700" stroke-width="1.5">क</text>
                    <text x="50" y="50" font-family="'Fredoka', sans-serif" font-size="34" font-weight="bold" fill="#FFC9F3" stroke="#A82885" stroke-width="1.5">ख</text>
                    <text x="30" y="85" font-family="'Fredoka', sans-serif" font-size="36" font-weight="bold" fill="#C3FFD8" stroke="#12702F" stroke-width="1.5">ग</text>
                    <!-- Music Note -->
            ...
            <h2 class="card-title">Hindi Rhymes</h2>
            <span class="card-subtitle">मजेदार कविताएँ सीखें</span>
        </a>
            ...
            <div class="card-icon-container">
                ...
                <svg viewBox="0 0 100 100" width="90" height="90">
                    <g transform="translate(15, 10)">
                        ...
                        <!-- Peacock Feather -->
                        <path d="M 35 23 Q 48 10 52 2 M 35 23 Q 22 10 35 23" fill="none" stroke="#228B22" stroke-width="2"/>
                        <ellipse cx="44" cy="12" rx="6" ry="10" fill="#008080" transform="rotate(30, 44, 12)"/>
                        <circle cx="44" cy="12" r="3" fill="#FF8C00"/>
                        <!-- Flute -->
                        <rect x="15" y="48" width="50" height="6" rx="2" fill="#D2B48C" stroke="#8B4513" stroke-width="1.5" transform="rotate(-15, 35, 50)"/>
                        ...
                        <path d="M 31 52 Q 35 56 39 52" stroke="#222" stroke-width="1.5" stroke-linecap="round" fill="none"/>
                    </g>
                </svg>
            </div>
            <h2 class="card-title">Devotional Learning</h2>
            <span class="card-subtitle">Mantras, Aartis & Stories</span>
        </a>
            ...
            <div class="card-icon-container">
                ...
                <svg viewBox="0 0 100 100" width="90" height="90">
                    <g transform="translate(10, 15)">
                        <!-- Book Pages -->
                        <path d="M5 40 Q40 30 40 10 L40 60 Q40 50 5 60 Z" fill="#FFFDF0" stroke="#8B4513" stroke-width="2"/>
                        <path d="M75 40 Q40 30 40 10 L40 60 Q40 50 75 60 Z" fill="#FFFDF0" stroke="#8B4513" stroke-width="2"/>
                        <!-- Om Symbol (ॐ) -->
                        <text x="25" y="44" font-family="sans-serif" font-size="22" font-weight="bold" fill="#D35400">ॐ</text>
                    </g>
                </svg>
            </div>
            <h2 class="card-title">Cultural Stories</h2>
            <span class="card-subtitle">Festivals, Moral Values</span>
        </a>
        ...
        <a href="{{ route('learning.numbers') }}" class="module-card module-card-green">
            <div class="card-icon-container">
                <svg viewBox="0 0 100 100" width="90" height="90">
                    <text x="12" y="55" font-family="'Fredoka', sans-serif" font-size="44" font-weight="900" fill="#FFDE59" stroke="#E6A100" stroke-width="2">1</text>
                    <text x="38" y="75" font-family="'Fredoka', sans-serif" font-size="48" font-weight="900" fill="#FF5252" stroke="#C62828" stroke-width="2">2</text>
                    <text x="68" y="55" font-family="'Fredoka', sans-serif" font-size="44" font-weight="900" fill="#38B6FF" stroke="#1B8EC7" stroke-width="2">3</text>
                </svg>
            </div>
            <h2 class="card-title">Number Counting</h2>
            <span class="card-subtitle">Learn 1-20 Numbers</span>
        </a>
        ...
        <a href="{{ route('learning.shapes') }}" class="module-card module-card-orange">
            ...
            <h2 class="card-title">Shapes Learning</h2>
            <span class="card-subtitle">Circles, Squares & More</span>
        </a>
        ...
        <a href="{{ route('learning.colors') }}" class="module-card module-card-pink">
            <div class="card-icon-container">
                <svg viewBox="0 0 100 100" width="90" height="90">
                    <path d="M 50 15 C 25 15 10 32 10 50 C 10 70 28 85 50 85 C 55 85 62 82 66 76 C 70 70 78 70 82 70 C 88 70 90 60 90 50 C 90 32 72 15 50 15 Z" fill="#F2EBD9" stroke="#7A6F5D" stroke-width="2"/>
            ...
            <h2 class="card-title">Colors Pop</h2>
            <span class="card-subtitle">Vibrant Colors Fun</span>
        </a>
        ...
        <a href="{{ route('learning.quiz') }}" class="module-card module-card-purple">
            <div class="card-icon-container">
                <svg viewBox="0 0 100 100" width="90" height="90">
                    <text x="35" y="70" font-family="'Fredoka', sans-serif" font-size="64" font-weight="900" fill="#FFDE59" stroke="#E6A100" stroke-width="3" transform="rotate(-5, 50, 50)">?</text>
            ...
            <span class="card-subtitle">Play, Test & Win Stars</span>
        </a>
        ...
        <a href="{{ route('parent.dashboard') }}" class="bottom-pill">
            <div class="pill-left">
                <div class="parent-avatar-frame" style="border-color: #2ECC71; position: relative; overflow: visible;">
                    ...
                    @elseif($activeChild->current_outfit === 'superhero')
                        <div class="avatar-accessory accessory-superhero" style="position: absolute; bottom: -2px; left: 50%; transform: translateX(-50%); width: 44px; height: 16px; z-index: 10; pointer-events: none;">
                            <svg viewBox="0 0 100 30" width="100%" height="100%">
                                <path d="M 10 5 L 30 25 L 50 10 L 70 25 L 90 5" fill="none" stroke="#FF5252" stroke-width="5" stroke-linecap="round"/>
                                <rect x="35" y="2" width="30" height="12" rx="4" fill="#FF5252" stroke="#C62828" stroke-width="1"/>
                            </svg>
